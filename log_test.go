...
func TestRequestLogger(t *testing.T) {
	Convey("Given an initialized ctx and proxy object", t, func() {
		// Set up proxy object
		...
		Convey("Log buffering works", func() {
...
func GetCTX(URL string, useragent string, proxy *ProxyHttpServer) (ProxyCtx) {
